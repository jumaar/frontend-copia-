...
export interface HistorialNeveraData {
  nevera: {
    id_nevera: number;
    id_tienda: number;
    nombre_tienda: string;
...
export interface HistorialTiendaResponse {
...
export interface ResumenGlobal {
  totalNeveras: number;
  totalEmpaquesPendientes: number;
  totalConsolidados: number;
  montoTotalEmpaques: number;
  montoTotalConsolidados: number;
